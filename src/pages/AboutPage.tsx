      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section className="bg-white rounded-2xl border border-stone-200 p-8 shadow-xs">
          <div className="max-w-3xl mb-8">
            ...
            <h2 className="text-3xl sm:text-4xl font-semibold tracking-tight text-stone-900 mb-2">
              Branderij en Ambacht
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
            <div className="p-5 bg-stone-50 rounded-xl border border-stone-200/80">
              <div className="font-semibold text-stone-900 text-base mb-1.5">Ambachtelijk Roasten</div>
            ...
            <div className="p-5 bg-stone-50 rounded-xl border border-stone-200/80">
              <div className="font-semibold text-stone-900 text-base mb-1.5">Klimaatbeheersing</div>
              <p className="text-stone-600 leading-relaxed">
            ...
            <div className="p-5 bg-stone-50 rounded-xl border border-stone-200/80">
              <div className="font-semibold text-stone-900 text-base mb-1.5">Kleine Batches</div>
              <p className="text-stone-600 leading-relaxed">
            ...
            <div className="p-5 bg-stone-50 rounded-xl border border-stone-200/80 md:col-span-2 lg:col-span-3">
              <div className="font-semibold text-stone-900 text-base mb-1.5">
        ...
        <section className="bg-stone-900 text-stone-100 rounded-3xl p-8 sm:p-12 shadow-xl relative overflow-hidden">
          <div className="max-w-4xl relative z-10">
            ...
            <blockquote className="my-8 pl-4 border-l-2 border-amber-400 text-amber-200 text-lg sm:text-xl font-medium leading-relaxed">
            ...
            <div className="mt-8">
              <MediaPlaceholder
                ...
                aspectRatio="video"
                className="bg-stone-800/80 border-stone-700 min-h-[300px]"
              />
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl border border-stone-200 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-semibold tracking-tight text-stone-900 mb-4">
              ...
              <div className="space-y-3 text-xs">
                <div className="p-4 bg-stone-50 rounded-xl border border-stone-200 flex justify-between items-center">
                  <div>
                    ...
                    <span className="block text-stone-500">Dendermonde (Centrum)</span>
                  </div>
                ...
                <div className="p-4 bg-stone-50 rounded-xl border border-stone-200 flex justify-between items-center">
                  <div>
                    ...
                    <span className="block text-stone-500">Wetteren (Marktplein)</span>
                  </div>
                ...
                <div className="p-4 bg-stone-50 rounded-xl border border-stone-200 flex justify-between items-center">
                  <div>
                    ...
                    <span className="block text-stone-500">Aalst (Grote Markt)</span>
                  </div>
                  <span className="text-xs text-amber-900 font-semibold">08:00 - 13:00</span>
                </div>
              </div>
