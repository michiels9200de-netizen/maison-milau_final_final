...
export const GIFTBOX_COFFEE_OPTIONS: GiftboxBeanOption[] = [
  { name: 'Budget Espresso', price: 6.95, collection: 'Budget' },
  { name: 'Budget Omni', price: 6.50, collection: 'Budget' },
  { name: 'Budget Filter', price: 6.95, collection: 'Budget' },
  { name: 'Value Espresso', price: 7.95, collection: 'Value' },
  { name: 'Value Omni', price: 7.50, collection: 'Value' },
  { name: 'Value Filter', price: 8.25, collection: 'Value' },
  { name: 'Selection Daily', price: 9.50, collection: 'Selection' },
  { name: 'Selection Espresso', price: 9.95, collection: 'Selection' },
  { name: 'Selection Filter', price: 9.95, collection: 'Selection' },
  { name: 'Premium Daily', price: 11.95, collection: 'Premium' },
  { name: 'Premium Espresso', price: 12.50, collection: 'Premium' },
  { name: 'Premium Filter', price: 11.95, collection: 'Premium' },
  { name: 'Prestige Daily', price: 14.95, collection: 'Prestige' },
  { name: 'Prestige Espresso', price: 13.95, collection: 'Prestige' },
  { name: 'Prestige Filter', price: 14.95, collection: 'Prestige' },
  { name: 'Moscatel Barrel Aged', price: 17.95, collection: 'Barrel Aged' },
  { name: 'Pedro Ximénez Barrel Aged', price: 17.95, collection: 'Barrel Aged' },
  { name: 'Buffalo Trace Bourbon Barrel', price: 18.95, collection: 'Barrel Aged' },
  { name: 'Milau Vanilla Infused', price: 11.95, collection: 'Infused' },
  { name: 'Milau Cinnamon Infused', price: 11.95, collection: 'Infused' },
  { name: 'Milau Almond Infused', price: 11.95, collection: 'Infused' },
  { name: 'Pink Bourbon Betulia Single Origin', price: 16.95, collection: 'Single Origins' },
  { name: 'Gesha Betulia Single Origin', price: 24.95, collection: 'Single Origins' },
];
