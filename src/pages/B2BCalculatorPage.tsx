...
import { ArrowLeft, ShieldCheck, HelpCircle, FileText, Phone, Mail } from 'lucide-react';

interface B2BCalculatorPageProps {
  navigate: (path: string) => void;
}

export const B2BCalculatorPage: React.FC<B2BCalculatorPageProps> = ({ navigate }) => {
  return (
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-stone-200">
          <div className="space-y-1">
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs text-amber-900 hover:text-amber-700 font-semibold mb-2 transition-colors cursor-pointer"
            >
